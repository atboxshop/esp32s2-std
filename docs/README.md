...
`run-wokwi.sh`. If no project id is specified, a DevKit for esp32s2 will be
used.
> **Warning**
>
...
- Terminal approach:
    ```
    $HOME/.espressif/tools/xtensa-esp32s2-elf/esp-2021r2-patch3-8.4.0/xtensa-esp32s2-elf/bin/xtensa-esp32s2-elf-gdb target/xtensa-esp32s2-espidf/debug/esp32s2_std -ex "target remote localhost:9333"
    ```
